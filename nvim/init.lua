...
-- Convert tabs to spaces of a file
vim.opt.expandtab = true
vim.opt.smartindent = true
-- Don't wrap long lines if view exceeds ( Let it overflow )
vim.opt.wrap = false
-- Full color support in terminal
vim.opt.termguicolors = true
-- Enable cursorcolumn
vim.opt.cursorcolumn = true
-- Enable standard word wrap column
...
vim.keymap.set("n", "<Leader>f", ":Lex<CR>", { silent = true }, { desc = "Open :Explore" })
...
require("lazy").setup({
	...
	-- Fixes clash of same keybind to switch between panes with tmux and neovim
	{
	...
	{ -- Collection of various small independent plugins/modules
		...
		config = function()
			...
			-- Highlight hex color code with that color
			require("mini.hipatterns").setup()

			-- Tag or bracket pairs
