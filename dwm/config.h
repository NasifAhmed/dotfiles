...
static Key keys[] = {
    ...
    */
    { MODKEY|ControlMask,           XK_KP_Subtract, spawn, SHCMD("pamixer --allow-boost -d 5 & pkill -RTMIN+10 dwmblocks") },
    { MODKEY|ControlMask,           XK_KP_Add, spawn, SHCMD("pamixer --allow-boost -i 5 & pkill -RTMIN+10 dwmblocks") },
